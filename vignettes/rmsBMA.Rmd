...
`model_space` reports the acceptance rate, the mean model size, the number of distinct models visited, and one figure that decides whether the run can be used at all.
