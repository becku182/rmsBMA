test_that("model_sizes returns three ggplot objects (dilution = 0)", {
  ...
  # Not wrapped in expect_silent(): these assertions are about the returned
  # objects, and a future ggplot2 deprecation message would otherwise fail
  # the test for a reason unrelated to what it checks.
  plots <- model_sizes(b)
