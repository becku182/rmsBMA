test_that("modelPMP builds correct mSize objects (1)", {
  ...
  graphsPMP<-modelPMP(Post)
  expect_equal(class(graphsPMP[[1]]),c("gg", "ggplot"))
  expect_equal(class(graphsPMP[[2]]),c("gg", "ggplot"))
  expect_equal(class(graphsPMP[[3]]),c("gg", "ggplot"))
  expect_equal(class(graphsPMP[[4]]),c("gg", "ggplot"))
  expect_equal(class(graphsPMP[[5]]),c("gg", "ggplot","ggarrange"))
  dev.off()
})

test_that("modelPMP builds correct mSize objects (2)", {
...
test_that("modelPMP builds correct mSize objects (3)", {
  x1<-rnorm(20, mean = 0, sd = 1)
  x2<-rnorm(20, mean = 0, sd = 2)
  x3<-rnorm(20, mean = 0, sd = 3)
  x4<-rnorm(20, mean = 0, sd = 1)
...
test_that("modelPMP builds correct mSize objects (4)", {
...
test_that("modelPMP builds correct mSize objects (5)", {
  x1<-rnorm(20, mean = 0, sd = 1)
  x2<-rnorm(20, mean = 0, sd = 2)
  x3<-rnorm(20, mean = 0, sd = 3)
  x4<-rnorm(20, mean = 0, sd = 1)
